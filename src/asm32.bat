...
rem -----------------------------------------------------------------
set INCLUDE=C:\LabArq2;C:\LabArq2\MASM;%INCLUDE%
...
set LIB=C:\LabArq2;C:\LabArq2\MASM;%LIB%
...
.\windbg -QY -g -G -y "c:\LabArq2\MASM\;c:\LabArq2\;c:\windows\system32\;SRV*C:\symbols*http://msdl.microsoft.com/download/symbols" -WF "C:\LabArq2\MASM\wkp.wew" -srcpath "C:\LabArq2\MASM\" %1.exe
